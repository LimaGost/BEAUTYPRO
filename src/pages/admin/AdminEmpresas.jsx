...
import {
  ...
  ChevronRight, Loader2, RefreshCw, Search, ExternalLink,
} from 'lucide-react';
...
export default function AdminEmpresas() {
  const { selectAdminCompany } = useAuth();
        ...
        <div className="space-y-3">
          {filtered.map((c, idx) => (
            ...
            >
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="flex items-center gap-3 min-w-0">
                    {c.logo_url ? (
                      ...
                      <div
                        className="w-10 h-10 rounded-xl flex items-center justify-center font-black text-black text-lg flex-shrink-0"
              ...
              {/* Rodapé */}
              {(c.cnpj || c.city || c.created_at) && (
                <div className="px-4 py-2 flex gap-3 flex-wrap border-t"
